                        ...
                        <div class="flex-1">
                            <form method="POST" action="{{ route('admin.templates.email.update', $emailTemplate) }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="body" name="body" rows="15" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm font-mono text-sm" required placeholder="Type your email body here or drag variables from the sidebar...">{{ old('body', $emailTemplate->body) }}</textarea>
                                    <x-input-error :messages="$errors->get('body')" class="mt-2" />
                                    <p class="text-sm text-gray-600 mt-1">Enter your email body using Blade template syntax. Drag and drop variables from the sidebar.</p>
                                </div>
