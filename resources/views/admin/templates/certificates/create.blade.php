                            ...
                            <form method="POST" action="{{ route('admin.templates.certificates.store') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div x-show="type === 'svg' && tab === 'visual'" class="mt-1 border border-gray-300 rounded-md p-4 bg-gray-50 overflow-auto min-h-[400px]"
                                        ...
                                        <div x-ref="visualPreview" x-html="svgContent" class="pointer-events-none [&>svg]:pointer-events-auto [&>svg]:w-full [&>svg]:h-auto [&>svg]:bg-white [&>svg]:shadow-sm">
                                            <div class="text-center text-gray-400 py-10" x-show="!svgContent.trim()">
                                                Enter valid SVG code in the Code tab first to see the visual preview.
                                            </div>
                                        </div>
