    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.documentation.update', $documentation) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" :value="old('title', $documentation->title)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="order" class="block mt-1 w-full" type="number" name="order" :value="old('order', $documentation->order)" required min="0" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="content" name="content" rows="20" class="border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm block mt-1 w-full" required>{{ old('content', $documentation->content) }}</textarea>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const easyMDE = new EasyMDE({
                ...
                autosave: {
                    enabled: true,
                    uniqueId: "documentation-edit-{{ $documentation->id }}",
                    delay: 1000,
                },
            });
        });
