    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('dashboard.smtp.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="port" class="block mt-1 w-full" type="number" name="port" :value="old('port', 587)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Your SMTP password or API key</p>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="from_address" class="block mt-1 w-full" type="email" name="from_address" :value="old('from_address')" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="from_name" class="block mt-1 w-full" type="text" name="from_name" :value="old('from_name')" required />
